...
public partial class CondoContext : DbContext
{
    ...
    public virtual DbSet<recibo_detalle> recibo_detalles { get; set; }

    public virtual DbSet<recibo_encabezado> recibo_encabezados { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<propiedad>(entity =>
        {
            ...
            entity.Property(e => e.direccion)
                .HasMaxLength(100)
                .IsUnicode(false);
            entity.Property(e => e.id_condominio)
                .HasMaxLength(5)
                .IsUnicode(false);

            entity.HasOne(d => d.id_condominioNavigation).WithMany(p => p.propiedads)
                .HasForeignKey(d => d.id_condominio)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__propiedad__id_co__3D5E1FD2");

            entity.HasMany(d => d.dpi_propietarios).WithMany(p => p.id_propiedads)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    l => l.HasOne<propiedad>().WithMany()
                        .HasForeignKey("id_propiedad")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK__propiedad__id_pr__45F365D3"),
                    j =>
                    {
                        j.HasKey("id_propiedad", "dpi_propietario").HasName("pk_propiedad_propietario");
                        j.ToTable("propiedad_propietario");
                        j.IndexerProperty<string>("id_propiedad")
                            .HasMaxLength(5)
                            .IsUnicode(false);
        ...
        modelBuilder.Entity<recibo_encabezado>(entity =>
        {
            ...
            entity.Property(e => e.num_rec)
                .HasMaxLength(8)
                .IsUnicode(false);
            entity.Property(e => e.dpi_propietario)
                .HasMaxLength(13)
                .IsUnicode(false);
            entity.Property(e => e.fecha_recibo).HasDefaultValueSql("(getdate())");
            entity.Property(e => e.id_propiedad)
                .HasMaxLength(5)
                .IsUnicode(false);

            entity.HasOne(d => d.dpi_propietarioNavigation).WithMany(p => p.recibo_encabezados)
                .HasForeignKey(d => d.dpi_propietario)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__recibo_en__dpi_p__4BAC3F29");

            entity.HasOne(d => d.id_propiedadNavigation).WithMany(p => p.recibo_encabezados)
        ...
        modelBuilder.HasSequence("seq_condominio")
            .HasMin(1L)
            .HasMax(999L);
        modelBuilder.HasSequence("seq_propiedad")
            .HasMin(1L)
            .HasMax(999L);
